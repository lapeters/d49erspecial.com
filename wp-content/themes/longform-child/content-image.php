...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		<div id="entry-content-wrapper">
			<p class="text-left author"><?php
			echo types_render_field("author", array("argument1"=>"value1","argument2"=>"value2","argument2"=>"value2"));
			?>, <em class="title"><?php
			echo types_render_field("position", array("argument1"=>"value1","argument2"=>"value2","argument2"=>"value2"));
			?></em></p>

			<p class="text-left"><?php
			echo types_render_field("publish-date", array("argument1"=>"value1","argument2"=>"value2","argument2"=>"value2"));
			?></p>
